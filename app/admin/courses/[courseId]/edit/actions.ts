...
export async function editCourse(
  ...
  try {
    ...
    const decidion = await aj.protect(req, {
      fingerprint: user.user.id,
    });

    if (decidion.isDenied()) {
      if (decidion.reason.isRateLimit()) {
        return {
          status: "error",
    ...
    return {
      status: "error",
      message: "Failed at updating the course",
    };
  }
}
...
export async function reorderLessons(
  ...
  try {
    ...
    return {
      status: "error",
      message: "Failed at reorder lessons.",
    };
  }
}
...
export async function reorderChapters(
  ...
  try {
    ...
    return {
      status: "error",
      message: "Failed at reorder chapters.",
    };
  }
}
...
export async function createChapter(
  ...
  try {
    ...
    return {
      status: "error",
      message: "Failed at creating chapter.",
    };
  }
}
...
export async function createLesson(
  ...
  try {
    ...
    return {
      status: "error",
      message: "Failed at creating lesson.",
    };
  }
}
