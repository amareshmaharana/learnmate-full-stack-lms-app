  ...
  return (
    <Link
      ...
      className={buttonVariants({
        ...
        className: cn(
          "w-full p-3 h-auto justify-start text-left transition-all hover:bg-primary/5",
          completed &&
    ...
    >
      <div className="flex items-center gap-2.5 w-full min-w-0">
        ...
        <div className="flex-1 text-left min-w-0">
          <p
            className={cn(
              "font-medium text-sm wrap-break-word whitespace-normal",
              completed
          ...
          {completed && (
            <p className="text-xs text-green-700 dark:text-green-300 mt-1.5 font-medium">
              Completed
            </p>
          )}
